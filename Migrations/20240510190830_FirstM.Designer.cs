...
namespace Book_Shop.Migrations
{
    ...
    [Migration("20240510190830_FirstM")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Book_Shop.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Book_Shop.Models.OrderItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Book_Shop.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Book_Shop.Models.Author", b =>
                {
                    b.HasOne("Book_Shop.Models.Publisher", "Publisher")
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("Book_Shop.Models.Order", b =>
                {
                    b.HasOne("Book_Shop.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Book_Shop.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
